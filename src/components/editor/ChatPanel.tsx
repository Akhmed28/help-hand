...
const ChatPanel = ({
  ...
  const getAgentInfo = (msg: Msg) => {
    if (msg.agent) {
      ...
      if (msg.agent === AUTO_IMPROVE_AGENT.name) return AUTO_IMPROVE_AGENT;
      if (msg.agent === AUTO_IMPROVE_DONE_AGENT.name) return AUTO_IMPROVE_DONE_AGENT;
    }
    return null;
  };
